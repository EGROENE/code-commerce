            ...
            >
                ...
                <label id={style.nameField}>
                  <div>
                    ...
                    <input
                      className={
                        hasFailedSubmission &&
                        (!validators.nameIsValid || shippingDetails.name === "")
                          ? "inputWhenError"
                          : undefined
                      }
              ...
              <label>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setOrderDetails("shipping", "streetAddress", e.target.value)
                  }
                  inputMode="text"
                  minLength="1"
                ...
                {hasFailedSubmission &&
                  shippingDetails.streetAddress !== "" &&
                  !validators.streetAddressIsValid && (
                    <FunctionalErrorMessage message="Please enter a valid address" />
                  )}
              </label>
              <div id={style.moreAddressDetails}>
                <label>
                  ...
                  <input
                    ...
                    type="text"
                    onChange={(e) => {
                      setOrderDetails("shipping", "postalCode", e.target.value);
                    }}
                    required
                    inputMode="numeric"
                    minLength="5"
                  ...
                  {hasFailedSubmission &&
                    shippingDetails.postalCode !== "" &&
                    !validators.postalCodeIsValid && (
                      <FunctionalErrorMessage message="5-digit US postal code" />
                    )}
                </label>
                <label>
                  <header>City: </header>
                  ...
                  {hasFailedSubmission &&
                    ...
                    !validators.cityIsValid && (
                      <FunctionalErrorMessage message="Enter a valid city" />
                    )}
                </label>
                <label>
              ...
              <label id={style.phoneField}>
                ...
                <input
                  ...
                  type="text"
                  onChange={(e) => {
                    setOrderDetails("shipping", "phoneNumber", e.target.value);
                    setOrderDetails(
                      "shipping",
                      "phoneNumberMask",
                ...
                {hasFailedSubmission &&
                  shippingDetails.phoneNumber !== "" &&
                  !validators.phoneNumberIsValid && (
                    <FunctionalErrorMessage message="10-digit, US number" />
                  )}
              </label>
            </form>
...
export default FunctionalShipping;
